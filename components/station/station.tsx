...
// import { StationBackground } from './station-background';
import { StationClerk } from './station-clerk';
import { StationBackground } from './station-background';
  ...
  return (
    ...
    <div className={styles.container}>
      <div className={styles.layout}>
        <section className={styles.clerkSection}>
          <div className={styles.clerkContent}>
            <StationClerk station={station} />
          </div>
        </section>
